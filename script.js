...
class MinimalistPortfolio {
    ...
    setupProjectInteractions() {
        ...
        githubLinks.forEach(link => {
            link.addEventListener('click', (e) => {
                e.preventDefault();
                this.showNotification('GitHub repository links coming soon!');
            });
        });
    }
    ...
    showNotification(message) {
        ...
        notification.className = 'fixed top-20 right-4 bg-gray-900 text-white px-4 py-3 rounded-lg shadow-lg z-50 text-sm max-w-xs';
